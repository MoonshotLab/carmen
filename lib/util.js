...
const getImagesSentCopyFromImgUrl = imgUrl => {
  return `Coming your way! Images take a moment to send, so please be patient. If for some reason that doesn't work, here's a link you can view in your browser: ${imgUrl}`;
};
...
module.exports = {
  ...
  getImagesSentCopyFromImgUrl: getImagesSentCopyFromImgUrl
};
